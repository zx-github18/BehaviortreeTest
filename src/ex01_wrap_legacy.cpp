...
// Similarly to the previous tutorials, we need to implement this parsing
// method, providing a specialization of BT::convertFromString
namespace BT {
...
int main()
{
    ...
    auto MoveToWrapperWithLambda =
        [&move_to](TreeNode &parent_node) -> NodeStatus {
        Point3D goal;
        // thanks to paren_node, you can access easily the input and output
        // ports.
